    ...
    return (
        <div>
            ...
            <form className="login-page" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input placeholder="Juan123" {...register("nombreUsuario", { validate: validarNombre })} />
                ...
                <div className="login-acciones">
                    ...
                    <div className="login-acciones-columnas">
                        <div className="login-oauth">
                            <a href="http://localhost:3000/api/auth/google" className="btn-oauth">
                                Continuar con Google
                            </a>
                            <a href="http://localhost:3000/api/auth/github" className="btn-oauth">
                                Continuar con GitHub
                            </a>
                            <a href="http://localhost:3000/api/auth/jira" className="btn-oauth">
                                Continuar con Jira
                            </a>
                        </div>
