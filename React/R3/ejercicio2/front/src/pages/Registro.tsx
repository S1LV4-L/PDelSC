...
import type { RegistroFormDatos, NavegacionProps } from "../types";
import "../styles/Registro.css";
import { ThemeToggle } from "../components/BotonTema";

export default function Registro({ setPagina }: NavegacionProps) {
        ...
        <div>
            ...
            <form className="registro-page" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="registro-acciones">
                    ...
                    <button type="button" className="btn-link" onClick={() => setPagina("login")}>
                        Ya tengo cuenta
                    </button>
                    <button type="button" className="btn-link" onClick={() => setPagina("home")}>
                        Volver al Home
                    </button>
                </div>
            </form>
