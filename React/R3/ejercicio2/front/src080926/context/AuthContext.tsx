...
export function AuthProvider({ children }: { children: ReactNode }) {
    ...
    return (
        <AuthContext.Provider value={{ usuario, login, registrar, solicitarRestablecimiento, logout }}>
            {children}
...
export const useAuth = (): AuthContextType => {
    ...
    if (!ctx) throw new Error("useAuth debe usarse dentro de AuthProvider"); // Previene fallos comprobando si existe el contexto.
    return ctx;
};